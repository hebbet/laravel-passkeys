...
it('can get the default action classes', function () {
    ...
    expect(Config::getActionClass('configure_ceremony_step_manager_factory', ConfigureCeremonyStepManagerFactoryAction::class))->not->toBeNull()->toBe(ConfigureCeremonyStepManagerFactoryAction::class);
});
